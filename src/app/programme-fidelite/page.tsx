    ...
    <>
      ...
      <section className="pt-32 pb-20" style={{ background: "#0A0A0A" }}>
        <div className="px-[5vw] text-center" style={{ maxWidth: "1400px", margin: "0 auto" }}>
          <p className="text-[12px] uppercase tracking-[0.2em] text-[#C9A96E] mb-4" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 500 }}>PROGRAMME DE FIDÉLITÉ</p>
          <h1 className="text-[36px] md:text-[48px] mb-6" style={{ fontFamily: "var(--font-playfair)", fontWeight: 700, color: "#F5F5F0" }}>
      ...
      <section className="section-padding" style={{ background: "#141414" }}>
        <div className="px-[5vw]" style={{ maxWidth: "1400px", margin: "0 auto" }}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {tiers.map((tier, i) => (
              <div key={tier.name} className="p-6 relative" style={{ background: "#0A0A0A", border: i === 3 ? "1px solid #C9A96E" : "1px solid #1E1E1E" }}>
                {i === 3 && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 text-[10px] uppercase tracking-[0.15em]"
                    style={{ background: "#C9A96E", color: "#0A0A0A", fontFamily: "var(--font-montserrat)", fontWeight: 600 }}>
                    Exclusif
                  </div>
                )}
                <h3 className="text-[24px] mb-2" style={{ fontFamily: "var(--font-playfair)", fontWeight: 600, color: i === 3 ? "#C9A96E" : "#F5F5F0" }}>
                  {tier.name}
                </h3>
                ...
                <ul className="space-y-3">
                  {tier.benefits.map((b) => (
                    <li key={b} className="flex items-start gap-2 text-[13px] text-[#A0A0A0]" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 300 }}>
                      <svg className="shrink-0 mt-0.5" width="14" height="14" fill="none" stroke="#C9A96E" strokeWidth="2" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" /></svg>
                      {b}
                    </li>
                  ))}
                </ul>
      ...
      <section className="section-padding" style={{ background: "#0A0A0A" }}>
        <div className="px-[5vw]" style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div className="text-center mb-12">
            <p className="text-[12px] uppercase tracking-[0.2em] text-[#C9A96E] mb-4" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 500 }}>CARTE PRÉPAYÉE</p>
            <h2 className="text-[28px] md:text-[36px] mb-4" style={{ fontFamily: "var(--font-playfair)", fontWeight: 600, color: "#F5F5F0" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {cardePrepayee.map((c) => (
              <div key={c.heures} className="text-center p-6" style={{ background: "#141414", border: "1px solid #1E1E1E" }}>
                <p className="text-[36px] text-[#C9A96E] mb-1" style={{ fontFamily: "var(--font-cormorant)", fontWeight: 300 }}>{c.heures}</p>
                <p className="text-[12px] text-[#6B6B6B] mb-4" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 300 }}>{c.prix}</p>
                <span className="inline-block px-3 py-1 text-[10px] uppercase" style={{ background: "rgba(201,169,110,0.1)", border: "1px solid #C9A96E", color: "#C9A96E", fontFamily: "var(--font-montserrat)", fontWeight: 600 }}>
                  -{c.economie}
                </span>
              </div>
            ))}
      ...
      <section className="py-20" style={{ background: "#141414" }}>
        <div className="px-[5vw] text-center" style={{ maxWidth: "600px", margin: "0 auto" }}>
          <h2 className="text-[28px] mb-4" style={{ fontFamily: "var(--font-playfair)", fontWeight: 600, color: "#F5F5F0" }}>
          ...
          <Link href="/contact" className="inline-block px-8 py-4 border text-[12px] uppercase tracking-[0.2em] transition-all duration-300 hover:bg-[#C9A96E] hover:text-[#0A0A0A]"
