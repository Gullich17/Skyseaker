...
function HeroSection() {
  const t = useTranslations('emptyLegs');
  return (
    <section
...
function StatsSection() {
  const t = useTranslations('emptyLegs');
  const stats = [
    { value: 75, suffix: '%', label: t('stats.averageSaving') },
    { value: emptyLegs.length, suffix: '+', label: t('stats.flightsAvailable') },
    { value: 30, suffix: 'min', label: t('stats.europeRoutes') },
    { value: 24, suffix: 'h/24', label: t('stats.reactivity') },
  ];
...
function AdvantagesSection() {
  ...
  const advantages = [
    {
      icon: <TagIcon />,
      title: t('advantages.items.savings.title'),
      description: t('advantages.items.savings.description'),
    },
    {
      icon: <ShieldIcon />,
      title: t('advantages.items.safety.title'),
      description: t('advantages.items.safety.description'),
    },
    {
      icon: <ClockIcon />,
      title: t('advantages.items.flexibility.title'),
      description: t('advantages.items.flexibility.description'),
    },
  ];
  ...
  return (
    <section className="section-padding" style={{ backgroundColor: '#0E202D' }}>
      <div className="container-luxury">
        <SectionTitle
          preTitle={t('advantages.preTitle')}
