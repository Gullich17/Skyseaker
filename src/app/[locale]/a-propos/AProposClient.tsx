...
function HistorySection() {
  ...
  const milestoneKeys = ['2015', '2017', '2019', '2021', '2023', '2025'] as const;

  const milestones = milestoneKeys.map((key) => ({
    year: t(`history.milestones.${key}.year`),
    title: t(`history.milestones.${key}.title`),
    desc: t(`history.milestones.${key}.description`),
  }));
  ...
  return (
    <section style={{ background: '#132A3A', padding: 'clamp(60px, 8vw, 120px) 0' }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 5vw' }}>
        ...
        >
          {values.map((v, i) => (
            <ScrollReveal key={v.key} delay={i * 0.15} style={{ height: '100%' }}>
              <div
                style={{
                  textAlign: 'center',
                  padding: '32px',
              ...
              >
                ...
                >
                  {t(`values.items.${v.key}.description`)}
                </p>
              </div>
            </ScrollReveal>
          ))}
...
function TeamSection() {
  ...
  const teamKeys = ['alexandre', 'camille', 'nicolas', 'sophie'] as const;
    ...
    photo:
      key === 'alexandre'
        ...
        : key === 'camille'
          ...
          : key === 'nicolas'
            ? 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=75'
            : 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&q=75',
  }));
...
function KeyFiguresSection() {
  ...
  const stats = [
    { value: 15000, suffix: '+', label: t('stats.flights') },
    { value: 120000, suffix: '+', label: t('stats.passengers') },
    { value: 50, suffix: '+', label: t('stats.destinations') },
...
function CertificationsSection() {
  ...
  const certKeys = ['ebaa', 'isbao', 'wyvern'] as const;

  const certifications = certKeys.map((key) => ({
    name: t(`certifications.items.${key}.name`),
    fullName: t(`certifications.items.${key}.fullName`),
    desc: t(`certifications.items.${key}.description`),
  }));
  ...
  return (
    <section style={{ background: '#0E202D', padding: 'clamp(60px, 8vw, 120px) 0' }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 5vw' }}>
        <SectionTitle
          preTitle={t('certifications.preTitle')}
...
function RSESection() {
  ...
  const rseItems = [
    { key: 'carbon', delay: 0.1 },
    { key: 'saf', delay: 0.2 },
    { key: 'optimisation', delay: 0.3 },
  ];
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              {rseItems.map((item) => (
                <ScrollReveal key={item.key} delay={item.delay}>
                  <div style={{ display: 'flex', gap: '16px' }}>
                    ...
                    <div>
                      ...
                      >
                        {t(`rse.items.${item.key}.description`)}
                      </p>
                    </div>
                  </div>
                </ScrollReveal>
