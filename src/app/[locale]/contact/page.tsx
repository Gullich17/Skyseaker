...
const officeKeys = ["paris", "monaco", "geneva", "dubai"] as const;
    ...
    <>
      ...
      <section className="pt-32 pb-20" style={{ background: "#0E202D" }}>
        <div className="px-[5vw] text-center" style={{ maxWidth: "1400px", margin: "0 auto" }}>
          <SectionTitle preTitle={t("hero.preTitle")} title={t("hero.title")} subtitle={t("hero.subtitle")} centered />
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <ScrollReveal className="lg:col-span-3">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label style={{ display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#A0A0A0", fontFamily: "var(--font-montserrat)", fontWeight: 500, marginBottom: "8px" }}>{t("form.lastName")}</label>
                    <input type="text" value={formData.lastName} onChange={(e) => setFormData({ ...formData, lastName: e.target.value })} required
                      className="w-full" />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#A0A0A0", fontFamily: "var(--font-montserrat)", fontWeight: 500, marginBottom: "8px" }}>{t("form.firstName")}</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label style={{ display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#A0A0A0", fontFamily: "var(--font-montserrat)", fontWeight: 500, marginBottom: "8px" }}>{t("form.email")}</label>
                    <input type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required
                      className="w-full" />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#A0A0A0", fontFamily: "var(--font-montserrat)", fontWeight: 500, marginBottom: "8px" }}>{t("form.phone")}</label>
                    <input type="tel" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                      className="w-full" />
                  </div>
                </div>
                <div>
                  <label style={{ display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#A0A0A0", fontFamily: "var(--font-montserrat)", fontWeight: 500, marginBottom: "8px" }}>{t("form.subject")}</label>
                  <select value={formData.subject} onChange={(e) => setFormData({ ...formData, subject: e.target.value })}
                    className="w-full">
                    <option value="quote" style={{ background: "#132A3A" }}>{t("form.subjects.quote")}</option>
                    <option value="partnership" style={{ background: "#132A3A" }}>{t("form.subjects.partnership")}</option>
                    <option value="press" style={{ background: "#132A3A" }}>{t("form.subjects.press")}</option>
                    <option value="careers" style={{ background: "#132A3A" }}>{t("form.subjects.careers")}</option>
                    <option value="other" style={{ background: "#132A3A" }}>{t("form.subjects.other")}</option>
                  </select>
                </div>
                <div>
                  <label style={{ display: "block", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#A0A0A0", fontFamily: "var(--font-montserrat)", fontWeight: 500, marginBottom: "8px" }}>{t("form.message")}</label>
            ...
            <ScrollReveal className="lg:col-span-2" delay={0.2}>
              <div className="space-y-10">
                {/* Direct Contact */}
                <div>
                  <h3 className="text-[11px] uppercase tracking-[0.2em] text-[#F4DDC3] mb-6" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 600 }}>{t("directContact")}</h3>
                ...
                {/* Offices */}
                <div>
                  <h3 className="text-[11px] uppercase tracking-[0.2em] text-[#F4DDC3] mb-6" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 600 }}>{t("ourOffices")}</h3>
