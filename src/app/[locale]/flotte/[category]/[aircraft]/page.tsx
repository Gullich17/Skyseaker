...
export async function generateMetadata({
  ...
  params: Promise<{ locale: string; category: string; aircraft: string }>;
}): Promise<Metadata> {
  const { locale, category, aircraft: aircraftId } = await params;
  ...
  const description = tData(aircraft.description, locale as Locale);
