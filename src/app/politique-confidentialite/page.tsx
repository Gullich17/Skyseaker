                  ...
                  <table className="w-full text-left" style={{ borderCollapse: "collapse" }}>
                    <thead>
                      <tr style={{ borderBottom: "1px solid #1E1E1E" }}>
                        <th className="pb-3 pr-4 text-[12px] uppercase tracking-[0.1em]" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 600, color: "#C9A96E" }}>Type</th>
                        <th className="pb-3 pr-4 text-[12px] uppercase tracking-[0.1em]" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 600, color: "#C9A96E" }}>Description</th>
                        <th className="pb-3 text-[12px] uppercase tracking-[0.1em]" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 600, color: "#C9A96E" }}>Durée</th>
                      </tr>
                    </thead>
                    <tbody>
                      {section.subtable.map((row, j) => (
                        <tr key={j} style={{ borderBottom: "1px solid rgba(30,30,30,0.5)" }}>
                          <td className="py-3 pr-4 text-[13px]" style={{ fontFamily: "var(--font-montserrat)", fontWeight: 400, color: "#F5F5F0" }}>{row.type}</td>
