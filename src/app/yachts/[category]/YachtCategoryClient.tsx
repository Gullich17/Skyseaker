        ...
        <div style={{ backgroundColor: "#141414", border: "1px solid #1E1E1E", borderRadius: "2px", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.3)", transition: "transform 0.4s ease, box-shadow 0.4s ease" }}>
          ...
          <div style={{ padding: "clamp(16px, 3vw, 24px)" }}>
            <h3
              ...
              style={{ fontFamily: "var(--font-playfair)", fontWeight: 600, color: "#F5F5F0", fontSize: "clamp(18px, 2.5vw, 22px)", marginBottom: "8px" }}
            >
              {yacht.name}
            </h3>
            ...
            <span
              ...
              style={{ display: "block", fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#C9A96E", fontFamily: "var(--font-montserrat)", fontWeight: 500, opacity: 0.6, transition: "opacity 0.3s ease" }}
            >
              Voir la fiche →
            </span>
          </div>
      ...
      <section style={{ position: "relative", minHeight: "clamp(400px, 55vh, 560px)", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: "1200px", margin: "0 auto", padding: "clamp(100px, 14vh, 160px) 24px clamp(40px, 6vw, 64px)" }}>
          ...
          <motion.h1
            ...
            style={{ fontFamily: "var(--font-playfair)", fontWeight: 700, color: "#F5F5F0", lineHeight: 1.1, fontSize: "clamp(32px, 6vw, 60px)", marginBottom: "16px" }}
          >
            {category.name}
          </motion.h1>
