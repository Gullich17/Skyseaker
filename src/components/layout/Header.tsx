  ...
  return (
    <>
      ...
      >
        <nav className="flex items-center justify-between h-[70px]" style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 clamp(20px, 5vw, 40px)" }}>
          ...
          <div className="hidden lg:flex items-center" style={{ gap: "clamp(16px, 2.5vw, 40px)" }}>
            {navLinks.map((link) => (
              ...
              >
                <Link
                  href={link.href}
                  className="uppercase text-[#FFFFFF] hover:text-[#F4DDC3] transition-colors duration-300 flex items-center gap-1"
          ...
          >
            <motion.span
              ...
              className="block w-6 h-[1.5px] bg-[#F4DDC3]"
            />
            <motion.span
        ...
        {/* Mega Menu backdrop */}
        {activeMega && (
          <div className="absolute top-full left-0 right-0 hidden lg:block" style={{ height: "400px", background: "#0F2535", zIndex: -1 }} />
        )}
              ...
              <div className="grid grid-cols-4" style={{ maxWidth: "1400px", margin: "0 auto", padding: "40px 5vw", gap: "12px" }}>
                {services.map((s) => (
                  <Link key={s.name} href={s.href} className="group transition-colors" style={{ padding: "20px 24px", borderRadius: "4px", background: "transparent" }}
                    onMouseEnter={(e) => (e.currentTarget.style.background = "#1A3448")}
                    onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}
                  >
                    <h4 className="text-[14px] text-[#FFFFFF] group-hover:text-[#F4DDC3] transition-colors mb-2"
                ...
                <div style={{ flex: "1 1 0" }}>
                  ...
                  <div className="grid grid-cols-2" style={{ gap: "6px 40px" }}>
                    {fleetCategories.map((c) => (
                      <Link key={c.name} href={c.href} className="text-[13px] text-[#A0A0A0] hover:text-[#F4DDC3] transition-colors"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            style={{ background: "#0E202D", overscrollBehavior: "contain" }}
          >
            {/* Spacer for nav */}
                      ...
                      <div style={{ borderBottom: "1px solid rgba(244,221,195,0.08)" }}>
                        <button
                          ...
                          style={{
                            ...
                            textTransform: "uppercase",
                            color: mobileAccordion === link.hasMega ? "#F4DDC3" : "#FFFFFF",
                        ...
                        >
                          ...
                          <motion.svg
                            ...
                            width="14" height="14" fill="none" stroke="#F4DDC3" strokeWidth="2" viewBox="0 0 24 24"
                          >
                            <path d="M19 9l-7 7-7-7" />
                          </motion.svg>
                        </button>
                              ...
                              <div style={{ paddingBottom: "16px", paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "2px" }}>
                                {(link.hasMega === "services" ? services : link.hasMega === "fleet" ? fleetCategories : yachtNavCategories).map((item) => (
                                  <Link
                                    ...
                                    onMouseEnter={(e) => (e.currentTarget.style.color = "#F4DDC3")}
